// Auto-generated UI Script for: officestaff
...
function openCreateForm() {
    const list = document.getElementById('cms-officestaff-list');
    const form = document.getElementById('cms-officestaff-form');
    if (list && form) {
